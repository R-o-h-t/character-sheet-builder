...
function PlusNode({ id, data, selected }: NodeProps<Node<PlusNodeProperties, number | { error: string }>>) {
...
export const definition: NodeDefinition<PlusNodeProperties, number | { error: string }> = {
  type: 'number-plus',
  icon: Plus,
  label: 'Plus',
  properties,
